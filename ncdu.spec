...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689784520
...
cp %{_builddir}/ncdu-%{version}/COPYING %{buildroot}/usr/share/package-licenses/ncdu/33810c236ab50fdbb900af9b57a8b2a3161cb201 || :
%make_install
